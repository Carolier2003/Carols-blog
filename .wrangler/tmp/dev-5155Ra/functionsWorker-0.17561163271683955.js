...
// .wrangler/tmp/pages-tEp1Sr/functionsWorker-0.17561163271683955.mjs
...
async function timingSafeEqual(a, b) {
  if (a.length !== b.length) {
    ...
    const aBuf2 = encoder2.encode(a);
    const bBuf2 = encoder2.encode(b);
    try {
      await crypto.subtle.digest("SHA-256", new Uint8Array(Math.max(aBuf2.length, bBuf2.length)));
    } catch {
    }
    return false;
  }
...
// .wrangler/tmp/bundle-WZoW5r/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-WZoW5r/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.17561163271683955.js.map
